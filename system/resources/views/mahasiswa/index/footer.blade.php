  ...
  <!--end switcher-->
  <!-- Bootstrap JS -->
  <script src="{{ asset(config('app.adm-assets')) }}/assets/js/bootstrap.bundle.min.js"></script>
  <!--plugins-->
  <script src="{{ asset(config('app.adm-assets')) }}/assets/js/jquery.min.js"></script>
  <script src="{{ asset(config('app.adm-assets')) }}/assets/plugins/simplebar/js/simplebar.min.js"></script>
  <script src="{{ asset(config('app.adm-assets')) }}/assets/plugins/metismenu/js/metisMenu.min.js"></script>
  <script src="{{ asset(config('app.adm-assets')) }}/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js"></script>
  <script src="{{ asset(config('app.adm-assets')) }}/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
  <script src="{{ asset(config('app.adm-assets')) }}/assets/plugins/datatable/js/dataTables.bootstrap5.min.js"></script>
