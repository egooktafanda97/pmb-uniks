        ...
        <div class="card border-primary border-bottom border-3 border-0 mb-3">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-pills mb-3 border-primary border-top border-3 border-0" role="tablist"
                    style="display: flex;justify-content: space-evenly; background: #fff; padding-bottom: 10px;padding-top: 10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
                    <li class="nav-item" role="presentation">
                        <a aria-selected="false" class="n-tab active" data-bs-toggle="pill" href="#x2"
                            role="tab" tabindex="-1">
                            <div class="d-flex align-items-center">
                                <div class="tab-title">PILIHAN PRODI</div>
                            </div>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a aria-selected="true" class="n-tab " data-bs-toggle="pill" href="#x3" role="tab">
                            <div class="d-flex align-items-center">
                                <div class="tab-title">DATA PERSONAL</div>
                            </div>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a aria-selected="true" class="n-tab" data-bs-toggle="pill" href="#x4" role="tab">
                            <div class="d-flex align-items-center">
                                <div class="tab-title">DATA ORANGTUA</div>
                            </div>
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="pills-tabContent">
                                        ...
                                        @foreach ($informasi_pendaftaran['jalur'] as $k => $v)
                                            @if ($v)
                                                <li
                                                    ...
                                                    <strong class="mb-0"
                                                        style="font-size: .8em">{{ strtoupper($k) }}</strong>
                                                    <span class=""
                                                        style="font-size: .8em">{{ strtoupper($v) }}</span>
                                                </li>
                                            @endif
                                        @endforeach
                                    </ul>
                    ...
                    <div class="tab-pane fade" id="x4" role="tabpanel">
                        <div class="card-header text-light bg-primary">
                            <div class="space-between">
