        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if ($url)
                        <img alt=""
                             src="{{ asset('assets/' . $queryes->brosur) }}"
                             width="100%">
                    @endif
                        ...
                        <div class="tab-pane fade show active"
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <strong class="mb-0"
                                            style="font-size: .8em">PENDAFATARAN</strong>
                                    <span class="text-secondary"
                                          style="font-size: .8em">{{ $queryes->pendaftaran }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <strong class="mb-0"
                                            style="font-size: .8em">TAHUN AJARAN</strong>
                                    <span class="text-secondary"
                                          style="font-size: .8em">{{ $queryes->tahun_ajaran }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <strong class="mb-0"
                                            style="font-size: .8em">DIBUKA TANGGAL</strong>
                                    <span class="text-secondary"
                                          style="font-size: .8em">{{ $queryes->buka }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <strong class="mb-0"
                                            style="font-size: .8em">DITUTUP TANGGAL</strong>
                                    <span class="text-secondary"
                                          style="font-size: .8em">{{ $queryes->tutup }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <strong class="mb-0"
                                            style="font-size: .8em">KUOTA</strong>
                                    <span class="text-secondary"
                                          style="font-size: .8em">{{ $queryes->kuota }}</span>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="card-header text-light bg-primary">
                    <div class="space-between">
                        ...
                        <button class="btn btn-primary btn-sm"
                                data-bs-target="#input-jadwal"
                                data-bs-toggle="modal"><i class="fa fa-plus"></i> Tambah</button>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            ...
                                            <a class="ms-3 delete"
                                               data-id="{{ $item->id }}"
                                               href="javascript:;"><i class="bx bxs-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
