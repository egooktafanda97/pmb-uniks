                                            ...
                                            <div class="div-action-container">
                                                <div aria-label="Basic example"
                                                    ...
                                                    <a class="btn btn-sm btn-outline-primary"
                                                       href="{{ url('admin/pengumuman/show/' . $item->id) }}"
                                                       type="button">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a class="btn btn-sm btn-outline-success"
                                                       href="{{ url('admin/pengumuman/update/' . $item->id) }}"
                                                       type="button">
...
@section('script')
    ...
    <script>
        ...
        function http_update_status_pendaftaran(status, id) {
            const option_http = {
                url: `{{ url('api/v1/pengumuman/up-status') }}/${id}?status=${status}`,
                header: {
                    headers: {
        ...
        $(".delete").click(function() {
            ...
            deleted({
                url: `{{ url('api/v1/pengumuman/delete') }}/${Id}`,
                header: headers,
                msg: null,
                errors: (res) => {
                    console.log(res);
