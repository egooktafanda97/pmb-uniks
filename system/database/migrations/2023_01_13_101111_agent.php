...
class Agent extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource('Agent');
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('Agent')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('Agent'));
    }
}
