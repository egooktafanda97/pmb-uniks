...
class PersyaratanUmum extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource('PersyaratanUmum');
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('PersyaratanUmum')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('PersyaratanUmum'));
    }
}
