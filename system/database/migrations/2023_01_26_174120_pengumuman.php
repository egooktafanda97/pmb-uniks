...
class Pengumuman extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource('Pengumuman');
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('Pengumuman')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('Pengumuman'));
    }
}
