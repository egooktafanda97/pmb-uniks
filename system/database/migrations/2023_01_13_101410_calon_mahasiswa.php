...
class CalonMahasiswa extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource('CalonMahasiswa');
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('CalonMahasiswa')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('CalonMahasiswa'));
    }
}
