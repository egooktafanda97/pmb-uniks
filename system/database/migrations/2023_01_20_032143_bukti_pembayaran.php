...
class BuktiPembayaran extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource('BuktiPembayaran');
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('BuktiPembayaran')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('BuktiPembayaran'));
    }
}
